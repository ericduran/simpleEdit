 ...
 */
var Meny={create:function(a){return(function(){console.log(a);if(!a||!a.menuElement||!a.contentsElement){throw"You need to specify which menu and contents elements to use.";
